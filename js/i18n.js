...
const STRINGS = {
  ko: {
    ...
    'filter.theme': '테마',
    'filter.quick': '빠른',
    'quick.thisWeekend': '이번 주말',
    'quick.thisWeek': '이번 주',
    'quick.nextMonth': '다음 달',
    'filter.all': '전체',
    'filter.reset': '필터 초기화',
    'filter.filters': '필터',
    ...
    'empty.hint': '필터를 줄이거나 다른 지역·테마를 선택해 보세요.',
    'loading.text': '불러오는 중…',
  ...
  en: {
    ...
    'filter.theme': 'Theme',
    'filter.quick': 'Quick',
    'quick.thisWeekend': 'This weekend',
    'quick.thisWeek': 'This week',
    'quick.nextMonth': 'Next month',
    'filter.all': 'All',
    ...
    'empty.hint': 'Try clearing filters or pick a different region/theme.',
  ...
  ja: {
    ...
    'empty.hint': 'フィルターを減らすか、別の地域・テーマを選んでください。',
    'loading.text': '読み込み中…',
