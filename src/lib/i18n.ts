...
export const t = {
  ...
  brandTag: {
    ko: '한국을 다시 발견하는 가장 쉬운 방법',
    en: 'The easiest way to rediscover Korea',
    ja: '韓国を新しく発見する一番簡単な方法',
    zh: '重新发现韩国最简单的方式',
  },
  pwaInstallText: {
  ...
  aboutBody: {
    ko: '<div class="about-brand"><div class="about-brand-mark" aria-hidden="true"><svg viewBox="0 0 64 64" width="56" height="56"><rect width="64" height="64" rx="14" fill="#171717"/><circle cx="46" cy="20" r="6" fill="#facc15"/><path d="M8 52 L20 28 L30 42 L40 22 L56 52 Z" fill="#fff"/></svg></div><p class="about-tag">한국을 다시 발견하는 가장 쉬운 방법</p></div><h2>왜 만들었나요?</h2><p>여행 정보가 너무 흩어져 있었습니다. 블로그·인스타·SNS·관광공사 사이트를 돌아다니다 보면 정작 가고 싶은 곳을 결정하지 못한 채 시간만 흘렀어요. 「한국 가볼 만한 곳」은 <strong>흩어진 정보를 한 곳에 모으고</strong>, 짧은 테스트로 <strong>나에게 맞는 여행지를 골라주는</strong> 사이트입니다.</p><h2>이런 분께</h2><ul><li>🎒 어디 갈지 막막한 여행 초보자</li><li>🗺️ 다음 주말·휴가 계획 세우는 사람</li><li>♿ 유모차·휠체어로도 갈 수 있는 곳 찾는 가족</li><li>🌐 한국 여행 추천을 외국인 친구에게 보내고 싶은 사람</li></ul><h2>핵심 기능</h2><ul><li><strong>13,000개 큐레이션</strong> — 한국관광공사 TourAPI + 직접 검수</li><li><strong>여행 성향 테스트</strong> — 6 페르소나 또는 4축 × 16유형 DNA 분석</li><li><strong>실시간 7일 날씨</strong> — Open-Meteo (5대 관광 도시 비교)</li><li><strong>4개 언어</strong> — 한국어·영어·일본어·중국어 + hreflang SEO</li><li><strong>지도 보기</strong> — Leaflet + 마커 클러스터</li><li><strong>즐겨찾기</strong> — localStorage, 가입 불필요</li></ul><h2>운영 방식</h2><p>본 사이트는 <strong>광고(Google AdSense)</strong>와 <strong>여행 어필리에이트(Agoda·Booking·Yanolja·KKday)</strong>로 운영비를 충당합니다. 사용자에게 별도 비용을 청구하지 않으며, 정보는 무료로 제공됩니다.</p><h2>운영자 / 연락</h2><ul><li>📬 문의·제안·오류 신고: <a href="https://github.com/hhakimm/festivals-site/issues" target="_blank" rel="noopener">GitHub Issues</a></li><li>📦 저장소: <a href="https://github.com/hhakimm/festivals-site" target="_blank" rel="noopener">github.com/hhakimm/festivals-site</a></li><li>📅 데이터 갱신: 매일 새벽 자동 (KTO TourAPI)</li><li>🚀 운영 시작: 2026년</li></ul><p class="muted" style="font-size:0.85rem">※ 일정·운영시간·요금 등은 변동될 수 있으니 방문 전 공식사이트에서 확인해 주세요.</p>',
    en: '<div class="about-brand"><div class="about-brand-mark" aria-hidden="true"><svg viewBox="0 0 64 64" width="56" height="56"><rect width="64" height="64" rx="14" fill="#171717"/><circle cx="46" cy="20" r="6" fill="#facc15"/><path d="M8 52 L20 28 L30 42 L40 22 L56 52 Z" fill="#fff"/></svg></div><p class="about-tag">The easiest way to rediscover Korea</p></div><h2>Why we built this</h2><p>Korean travel info was scattered everywhere — blogs, Instagram, KTO websites. By the time you finished searching, you still couldn\'t decide where to go. <strong>Travel Korea brings it all together</strong> and uses a short quiz to <strong>match destinations to your personality</strong>.</p><h2>Who it\'s for</h2><ul><li>🎒 First-time visitors unsure where to start</li><li>🗺️ Anyone planning a weekend or vacation</li><li>♿ Families needing barrier-free options</li><li>🌐 Locals sharing Korea picks with friends abroad</li></ul><h2>Core features</h2><ul><li><strong>13,000 curated picks</strong> — Korea Tourism Organization TourAPI + hand-curated</li><li><strong>Travel personality quiz</strong> — 6 personas OR 4-axis × 16-type DNA</li><li><strong>7-day live weather</strong> — Open-Meteo (5 major cities)</li><li><strong>4 languages</strong> — KO/EN/JA/ZH + hreflang SEO</li><li><strong>Map view</strong> — Leaflet + marker clustering</li><li><strong>Favorites</strong> — localStorage, no signup</li></ul><h2>How it runs</h2><p>Supported by <strong>Google AdSense</strong> and <strong>travel affiliates</strong> (Agoda, Booking, Yanolja, KKday). Free for users — no fees.</p><h2>Operator / Contact</h2><ul><li>📬 Inquiries / bugs: <a href="https://github.com/hhakimm/festivals-site/issues" target="_blank" rel="noopener">GitHub Issues</a></li><li>📦 Repository: <a href="https://github.com/hhakimm/festivals-site" target="_blank" rel="noopener">github.com/hhakimm/festivals-site</a></li><li>📅 Data refresh: daily, automatic</li><li>🚀 Launched: 2026</li></ul><p class="muted" style="font-size:0.85rem">※ Schedules, hours, and fees may change. Please verify on official sites before visiting.</p>',
    ja: '<p>「韓国旅行」は、韓国観光公社のTourAPIデータをもとに、韓国全国の観光地と月別フェスティバルを紹介する無料ガイドサイトです。</p><p>韓国語・英語・日本語・中国語に対応し、地域・テーマ・日付・現在地などから探索できます。</p><p>サイト運営は広告(Google)および旅行アフィリエイト(Agoda、Booking、Yanolja、KKday など)に支えられており、利用は無料です。</p><h2>運営者情報 / お問い合わせ</h2><p>個人開発者が運営する非営利のガイドサイトです。</p><ul><li>お問い合わせ・ご提案・不具合報告: <a href="https://github.com/hhakimm/festivals-site/issues" target="_blank" rel="noopener">GitHub Issues</a></li><li>リポジトリ: <a href="https://github.com/hhakimm/festivals-site" target="_blank" rel="noopener">github.com/hhakimm/festivals-site</a></li><li>データ更新: 毎日自動(韓国観光公社 TourAPI)</li><li>運営開始: 2026年</li></ul><p class="muted" style="font-size:0.85rem">※ 日程·営業時間·料金は変動する場合があります。訪問前に公式サイトでご確認ください。</p>',
    zh: '<p>"韩国旅行"是一个免费指南网站,基于韩国观光公社 TourAPI 数据,介绍韩国全国的旅游景点和每月节庆。</p><p>支持中文、韩语、英语、日语,可按地区、主题、日期、附近等多种方式探索。</p><p>本网站通过广告(Google)及旅行联盟营销(Agoda、Booking、Yanolja、KKday 等)运营,免费使用。</p><h2>运营者信息 / 联系</h2><p>由个人开发者运营的非商业指南网站。</p><ul><li>咨询·建议·错误报告: <a href="https://github.com/hhakimm/festivals-site/issues" target="_blank" rel="noopener">GitHub Issues</a></li><li>仓库: <a href="https://github.com/hhakimm/festivals-site" target="_blank" rel="noopener">github.com/hhakimm/festivals-site</a></li><li>数据更新: 每日自动(韩国观光公社 TourAPI)</li><li>启动: 2026 年</li></ul><p class="muted" style="font-size:0.85rem">※ 日程·营业时间·费用可能变动,访问前请到官方网站确认。</p>',
  },
  // Privacy 페이지 본문
  privacyTitle: {
    ko: '개인정보처리방침',
  ...
  // Contact 페이지 본문 (구글 폼 임베드)
  contactTitle: {
    ko: '문의 — 한국 가볼 만한 곳',
    en: 'Contact — Travel Korea',
    ja: 'お問い合わせ — 韓国旅行',
    zh: '联系 — 韩国旅行',
  },
  contactBody: {
    ko: '<p>서비스 이용 중 궁금한 점, 광고·제휴 제안, 정보 오류 신고 등 무엇이든 아래 양식으로 보내주세요. 운영자가 직접 확인합니다.</p><iframe src="https://docs.google.com/forms/d/e/1FAIpQLScxPBH7qft8vdAjFLBsta0kvWAscFYI-tOLNiJxK2bzd1ZPYQ/viewform?embedded=true" width="100%" height="900" frameborder="0" marginheight="0" marginwidth="0" loading="lazy" title="문의 양식" style="width:100%;max-width:100%;border:0;min-height:820px;">로드 중…</iframe><p class="muted">양식이 보이지 않으면 <a href="https://docs.google.com/forms/d/e/1FAIpQLScxPBH7qft8vdAjFLBsta0kvWAscFYI-tOLNiJxK2bzd1ZPYQ/viewform" target="_blank" rel="noopener">새 창에서 문의하기</a>를 눌러주세요.</p>',
    en: '<p>Have a question, an advertising or partnership proposal, or found an error? Send it via the form below — the operator reviews every message personally.</p><iframe src="https://docs.google.com/forms/d/e/1FAIpQLScxPBH7qft8vdAjFLBsta0kvWAscFYI-tOLNiJxK2bzd1ZPYQ/viewform?embedded=true" width="100%" height="900" frameborder="0" marginheight="0" marginwidth="0" loading="lazy" title="Contact form" style="width:100%;max-width:100%;border:0;min-height:820px;">Loading…</iframe><p class="muted">If the form does not appear, <a href="https://docs.google.com/forms/d/e/1FAIpQLScxPBH7qft8vdAjFLBsta0kvWAscFYI-tOLNiJxK2bzd1ZPYQ/viewform" target="_blank" rel="noopener">open it in a new tab</a>.</p>',
    ja: '<p>ご質問、広告・提携のご提案、情報の誤りのご報告など、下のフォームからお気軽にお送りください。運営者が直接確認します。</p><iframe src="https://docs.google.com/forms/d/e/1FAIpQLScxPBH7qft8vdAjFLBsta0kvWAscFYI-tOLNiJxK2bzd1ZPYQ/viewform?embedded=true" width="100%" height="900" frameborder="0" marginheight="0" marginwidth="0" loading="lazy" title="お問い合わせフォーム" style="width:100%;max-width:100%;border:0;min-height:820px;">読み込み中…</iframe><p class="muted">フォームが表示されない場合は<a href="https://docs.google.com/forms/d/e/1FAIpQLScxPBH7qft8vdAjFLBsta0kvWAscFYI-tOLNiJxK2bzd1ZPYQ/viewform" target="_blank" rel="noopener">新しいタブで開いてください</a>。</p>',
    zh: '<p>无论是使用疑问、广告或合作提议，还是信息纠错，都欢迎通过下方表单留言。运营者会亲自查看。</p><iframe src="https://docs.google.com/forms/d/e/1FAIpQLScxPBH7qft8vdAjFLBsta0kvWAscFYI-tOLNiJxK2bzd1ZPYQ/viewform?embedded=true" width="100%" height="900" frameborder="0" marginheight="0" marginwidth="0" loading="lazy" title="联系表单" style="width:100%;max-width:100%;border:0;min-height:820px;">加载中…</iframe><p class="muted">如果表单未显示，请<a href="https://docs.google.com/forms/d/e/1FAIpQLScxPBH7qft8vdAjFLBsta0kvWAscFYI-tOLNiJxK2bzd1ZPYQ/viewform" target="_blank" rel="noopener">在新窗口打开</a>。</p>',
  },
};
