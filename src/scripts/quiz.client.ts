...
const SHARE_TEXT: Record<Lang, Record<PersonaId, string>> = {
  ko: {
    naturalist: '나는 자연주의자래! 너는 어떤 여행자일까?',
    cultural: '나는 문화탐험가래! 너는 어떤 여행자일까?',
    resort: '나는 휴양가래! 너는 어떤 여행자일까?',
    adventurer: '나는 모험가래! 너는 어떤 여행자일까?',
    family: '나는 가족여행자래! 너는 어떤 여행자일까?',
    urbanite: '나는 도시탐험가래! 너는 어떤 여행자일까?',
  },
  en: {
    naturalist: "I'm a Naturalist traveler! What's your type?",
    cultural: "I'm a Cultural Explorer! What's your type?",
    resort: "I'm a Resort Lover! What's your type?",
    adventurer: "I'm an Adventurer! What's your type?",
    family: "I'm a Family Traveler! What's your type?",
    urbanite: "I'm a City Explorer! What's your type?",
  },
  ja: {
    naturalist: '私はナチュラリストらしい!あなたは?',
    cultural: '私は文化探検家らしい!あなたは?',
    resort: '私はリラックス派らしい!あなたは?',
    adventurer: '私は冒険家らしい!あなたは?',
    family: '私はファミリートラベラーらしい!あなたは?',
    urbanite: '私はシティエクスプローラーらしい!あなたは?',
  },
  zh: {
    naturalist: '我是自然主义者!你呢?',
    cultural: '我是文化探险家!你呢?',
    resort: '我是度假爱好者!你呢?',
    adventurer: '我是冒险家!你呢?',
    family: '我是家庭旅行者!你呢?',
