...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 630" preserveAspectRatio="xMidYMid slice">
  ...
  <circle cx="1080" cy="100" r="48" fill="${badge}" opacity="0.9"/>

  <rect x="60" y="56" width="240" height="44" rx="22" fill="${badge}"/>
  <text x="180" y="86" text-anchor="middle" font-family="Pretendard, system-ui, -apple-system, sans-serif" font-size="20" font-weight="700" fill="${badgeText}">여행 성향 테스트</text>
